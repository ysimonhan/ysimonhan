...
I focus on deployed AI workflow systems: agents, tool integrations, async backends, Langdock custom actions, Railway and Azure deployments, and human-in-the-loop processes for internal and external client operations.

## Current Focus

- Langdock custom integrations for customized internal AI workflows with Langdock being our core internal AI platform
- E2E-RAG pipelines that overperform basic Sharepoint Integrations (MS Graph API)
